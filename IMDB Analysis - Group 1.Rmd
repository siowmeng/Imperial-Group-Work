...
This cleansed dataset contains no NA values and is used for the remainder of the analysis.
...
10% of the dataset is then set aside to be the "test" dataset, leaving the remaining 90% of our dataset as the training dataset. The training dataset alone will be used for all descriptive, inferential and predictive analysis, including model building. The "test" dataset will be used at a later stage to check the accuracy of the predicted model.
