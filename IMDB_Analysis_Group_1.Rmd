...
### Decades
Boxplot gross against year, decade
```{r, echo = FALSE, fig.width = 10, fig.align = "center"}
...
The above plot shows that there might be a slight upward trend in gross revenue over the years. Some years, however, include fewer than ten movies. To get a more accurate picture of the development of gross revenues over time the foloowing two plots will only include years which have a minimum of ten entries.
