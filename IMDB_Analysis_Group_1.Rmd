...
summary(model5)
>>>>>>> 8a6f008ec9642d35f956f1631cd7d047ac1ceb8f
...
model5 <- lm(imdb_score ~ budget, data = movies[movies$title_year >= 2010, ])
summary(model5)
ggplot(data = movies, aes(x = budget, y = gross)) + geom_point() + geom_smooth(method = "lm") + coord_cartesian(xlim = c(0, 3e8))
...
model6 <- lm(imdb_score ~ director_facebook_likes + cast_total_facebook_likes + gross + actor_1_facebook_likes + actor_2_facebook_likes + actor_3_facebook_likes + director_facebook_likes + director_name, data = movies[movies$title_year >= 2010, ])
summary(model6)
...
model7 <- lm(gross ~ budget + content_rating + actor_1_facebook_likes + actor_2_facebook_likes + actor_3_facebook_likes + cast_total_facebook_likes + director_facebook_likes + imdb_score, data = movies)
summary(model7)

#adjusted R-squared value: 0.2859

model8 <- lm(gross ~ director_facebook_likes + cast_total_facebook_likes + imdb_score + country + actor_1_facebook_likes + actor_2_facebook_likes + actor_3_facebook_likes + content_rating, data = movies[movies$title_year >= 2010, ])
summary(model8)

#adjusted R-squared value: 0.3668

model9 <- lm(gross ~ director_facebook_likes + cast_total_facebook_likes + actor_1_facebook_likes + actor_2_facebook_likes + actor_3_facebook_likes + content_rating + budget, data = movies[movies$title_year >= 2010, ])
summary(model9)
