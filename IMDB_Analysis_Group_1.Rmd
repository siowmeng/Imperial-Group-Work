...
Descriptive analysis on the the budget
...
Also, the opposite of the initial intuition appears to be the case for variance, . This can be explained by the different number of movies in each set.
...
<<<<<<< HEAD
model5 <- lm(imdb_score ~ country + genres + movie_facebook_likes + language + num_user_for_reviews + num_critic_for_reviews + content_rating, data = train[title_year >= 2010, ])
summary(model5)

#adjusted R-squared value = 0.4267
=======
model5 <- lm(imdb_score ~ country + genres + movie_facebook_likes + language + num_user_for_reviews + num_critic_for_reviews, data = train)
summary(model5)
```
>>>>>>> 622a7bfe59750ec7a622a3dc344ea391e0d65e3f

model6 <- lm(imdb_score ~ genres + language + content_rating + country + title_year + movie_facebook_likes + cast_total_facebook_likes, data = train[title_year >= 2010, ])
summary(model6)

#adjusted R-squared value = 0.3881
...
model6 <- lm(imdb_score ~ budget, data = movies[movies$title_year >= 2010, ])
summary(model5)
ggplot(data = movies, aes(x = budget, y = gross)) + geom_point() + geom_smooth(method = "lm") + coord_cartesian(xlim = c(0, 3e8))
...
<<<<<<< HEAD
model7 <- lm(imdb_score ~ director_facebook_likes + cast_total_facebook_likes + gross + actor_1_facebook_likes + actor_2_facebook_likes + actor_3_facebook_likes + director_facebook_likes + director_name, data = movies[movies$title_year >= 2010, ])
=======
model6 <- lm(imdb_score ~ director_facebook_likes + cast_total_facebook_likes + gross + actor_1_facebook_likes + actor_2_facebook_likes + actor_3_facebook_likes + director_name, data = movies[movies$title_year >= 2010, ])
>>>>>>> 622a7bfe59750ec7a622a3dc344ea391e0d65e3f
summary(model6)
...
model8 <- lm(gross ~ budget + content_rating + actor_1_facebook_likes + actor_2_facebook_likes + actor_3_facebook_likes + cast_total_facebook_likes + director_facebook_likes + imdb_score, data = movies)
summary(model7)

#adjusted R-squared value: 0.2859

model9 <- lm(gross ~ director_facebook_likes + cast_total_facebook_likes + imdb_score + country + actor_1_facebook_likes + actor_2_facebook_likes + actor_3_facebook_likes + content_rating, data = movies[movies$title_year >= 2010, ])
summary(model8)

#adjusted R-squared value: 0.3668

<<<<<<< HEAD
model10 <- lm(gross ~ director_facebook_likes + cast_total_facebook_likes + actor_1_facebook_likes + actor_2_facebook_likes + actor_3_facebook_likes + content_rating + budget, data = movies[movies$title_year >= 2010, ])
=======
model9 <- lm(gross ~ director_facebook_likes + actor_1_facebook_likes + actor_2_facebook_likes + actor_3_facebook_likes + content_rating + budget, data = movies[movies$title_year >= 2010, ])
>>>>>>> 622a7bfe59750ec7a622a3dc344ea391e0d65e3f
summary(model9)
