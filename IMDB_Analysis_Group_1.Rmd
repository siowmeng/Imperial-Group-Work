...
ggplot(temp, aes(x = factor(title_year), y = gross, fill = factor(title_year))) + 
    geom_boxplot() +
    theme_bw() + 
    theme(axis.text.x=element_text(angle = 90, hjust = 0.5, vjust = 0.5), legend.position = "None", axis.title.x = element_blank()) +
...
ggplot(movies, aes(x = factor(title_year), y = gross, fill = factor(title_year))) + 
  geom_boxplot() +
  theme(axis.text.x=element_text(angle=90, hjust=0.5, vjust=0.5),legend.position = "None") +
  labs(title = "Gross revenues plotted against years", x = "", y = "Gross Revenue")
```
