...
ggplot(movies, aes(country, gross, fill = country)) + 
    geom_boxplot() + 
...
ggplot(USA, aes(x = gross, y = imdb_score, colour = "#009E73")) + geom_point() + ggtitle("Gross Revenue against IMDB Score for USA") + labs(x = "Gross", y = "IMDB Score")

ggplot(UK, aes(x = gross, y = imdb_score, colour = "0072B2")) + geom_point() + ggtitle("Gross Revenue against IMDB Score for UK") + labs(x = "Gross", y = "IMDB Score")

ggplot(Fra, aes(x = gross, y = imdb_score, colour = "D55E00")) + geom_point() + ggtitle("Gross Revenue against IMDB Score for France") + labs(x = "Gross", y = "IMDB Score")

ggplot(Ger, aes(x = gross, y = imdb_score)) + geom_point() + ggtitle("Gross Revenue against IMDB Score for Germany") + labs(x = "Gross", y = "IMDB Score")

ggplot(Can, aes(x = gross, y = imdb_score)) + geom_point() + ggtitle("Gross Revenue against IMDB Score for Canada") + labs(x = "Gross", y = "IMDB Score")

ggplot(Aus, aes(x = gross, y = imdb_score)) + geom_point() + ggtitle("Gross Revenue against IMDB Score for Australia") + labs(x = "Gross", y = "IMDB Score")

ggplot(Spa, aes(x = gross, y = imdb_score)) + geom_point() + ggtitle("Gross Revenue against IMDB Score for Spain") + labs(x = "Gross", y = "IMDB Score")

ggplot(Jap, aes(x = gross, y = imdb_score)) + geom_point() + ggtitle("Gross Revenue against IMDB Score for Japan") + labs(x = "Gross", y = "IMDB Score")

ggplot(Chi, aes(x = gross, y = imdb_score)) + geom_point() + ggtitle("Gross Revenue against IMDB Score for China") + labs(x = "Gross", y = "IMDB Score")

ggplot(Ind, aes(x = gross, y = imdb_score)) + geom_point() + ggtitle("Gross Revenue against IMDB Score for India") + labs(x = "Gross", y = "IMDB Score")
