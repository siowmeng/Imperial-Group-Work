...
ggplot(data = dfFB2010, aes(x = y_predict, y = y_actual)) + geom_point(colour = "red") + 
    geom_abline(colour = "blue") + xlab("Predicted Gross Revenue (US$)") + 
    ylab("Actual Gross Revenue(US$)") + 
    coord_cartesian(xlim = c(-0.2e8, 1.5e8), ylim = c(0, 2.5e8))
ggplot(data = dfFB2010, aes(x = y_predict, y = y_actual - y_predict)) + 
...
ggplot(data = dfFull2010, aes(x = y_predict, y = y_actual)) + geom_point(colour = "red") + 
    geom_abline(colour = "blue") + xlab("Predicted Gross Revenue (US$)") + 
    ylab("Actual Gross Revenue(US$)") + 
    coord_cartesian(xlim = c(-0.2e8, 1.5e8), ylim = c(0, 2.5e8))
ggplot(data = dfFull2010, aes(x = y_predict, y = y_actual - y_predict)) + 
    geom_point(colour = "red") + geom_hline(yintercept = 0, colour = "blue") + 
    xlab("Predicted Gross Revenue (US$)") + ylab("Residual(US$)") + 
    coord_cartesian(xlim = c(-0.2e8, 2e8), ylim = c(-1.5e8, 1.5e8))
...
ggplot(data = dfKnown2010, aes(x = y_predict, y = y_actual)) + geom_point(colour = "red") + 
    geom_abline(colour = "blue") + xlab("Predicted Gross Revenue (US$)") + 
    ylab("Actual Gross Revenue(US$)") + 
    coord_cartesian(xlim = c(-0.2e8, 1.5e8), ylim = c(0, 2.5e8))
ggplot(data = dfKnown2010, aes(x = y_predict, y = y_actual - y_predict)) + 
    geom_point(colour = "red") + geom_hline(yintercept = 0, colour = "blue") + 
    xlab("Predicted Gross Revenue (US$)") + ylab("Residual(US$)") + 
    coord_cartesian(xlim = c(-0.2e8, 2e8), ylim = c(-1.5e8, 1.5e8))
