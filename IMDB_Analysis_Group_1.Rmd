...
cor.test(data = topratedmovies, topratedmovies$imdb_score, topratedmovies$gross)
...
# Is the IMDB Score for movies with rating PG-13 different from those that are rated G?
t.test(movies$imdb_score[movies$content_rating == "PG-13"], movies$imdb_score[movies$content_rating == "G"], alternative = "greater")

t.test(movies$gross[movies$content_rating == "PG-13"], movies$gross[movies$content_rating == "G"], alternative = "greater")
```
