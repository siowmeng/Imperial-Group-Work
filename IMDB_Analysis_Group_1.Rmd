...
The above plot shows the development of gross revenue since the release of Facebook in 2005. There is an upward trend (note, the y axis is logarithmic), which is a different pattern compared to the plot with displaying all years with more than ten entries.
