...
Based on the t-tests we observe that the diffirences between the average values of gross revenues between some distinct genres are significant, thus including the variables genres in our linear regression models might give us an improved performance. 
