...
```{r, echo = FALSE}
# create function that converst years into decades
...
for (i in 1:nrow(movieswithdirectordata)){
...
```{r echo = FALSE}
##first get a data set including the # of directors movies + the genre matrix
...
cor.test(movies$imdb_score,movies$gross)
