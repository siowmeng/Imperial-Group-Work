...
* Budget is correlated with gross revenue, but not particularly strongly. 
* Language, country, content rating, genres, the number of movies produced by a director and the popularity of cast and director based on facebook likes, all have an impact on gross revenue.
* Our predictive models are able predict the gross revenue with a Root-Mean-Square Error of 37-56 million, depending on the chosen variables in the particular model.
* To produce a movie that will generate maximum gross revenues, one should consider making a long, animated, family movie, made in the US in English, rated PG-13, including actors as well as directors who are popular on facebook, and the director should have produced at least 10 movies.
