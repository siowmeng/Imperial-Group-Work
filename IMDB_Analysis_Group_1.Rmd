...
trainwithdirectorandgenredata$english <- factor(trainwithdirectorandgenredata$language == "English", 
                                                levels = c(TRUE, FALSE), labels = c("English", 
                                                                                    "Non-English"))
fbmodel <- lm(gross ~ budget + movie_facebook_likes + cast_total_facebook_likes 
